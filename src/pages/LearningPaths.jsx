...
const LearningPaths = () => {
  ...
  return (
    <section className="flex flex-col items-center justify-center text-center gap-y-4">
      <div className="mt-20 text-4xl md:text-5xl text-center">
            ...
            return (
              <div
                ...
                className={`w-1/2 border-2  items-center flex flex-wrap m-auto overflow-x-auto gap-x-4 mt-4 cursor-pointer hover:border-blue-600 active:bg-slate-500 ${
                  val.title === selectlearnings ? "bg-green-400" : ""
                }`}
